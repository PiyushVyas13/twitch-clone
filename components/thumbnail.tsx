import {UserAvatar} from "@/app/(browse)/_components/user-avatar";
...
export const Thumbnail = ({src, fallback, isLive, username}: ThumbnailProps) => {
    ...
    if(!src) {
        ...
        content = (
            <Image src={src} alt="thumbnail" fill className="object-cover transition-transform group-hover:translate-x-2 group-hover:-translate-y-2 rounded-md "/>
        )
    }
